...
"""Сторож живого счёта: пишет Сергею в Телеграм, когда что-то случилось.
    ...
    ⚠ С 04.09.2026 в облаке НЕ вызывается — сторож переехал на VDS
    (w2w_guard.ps1 в w2w_setup на Яндекс.Диске): расписание GitHub
    просыпалось через раз и опаздывало на часы. Здесь скрипт оставлен
    как запасной и для ручной проверки с мака.
